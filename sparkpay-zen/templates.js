    ...
    var toggleButton =      `<section class="toggle-wrapper">
                                 <button class="mdc-fab toggle-editor">
    ...
    var revealMiniNav =     `<nav class="reveal-container">
                                <div class="reveal-item duplicate-window">
                                    <span class="item-label">Duplicate Window</span>
